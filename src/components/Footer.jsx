      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col items-center justify-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-6 text-sm text-gray-400">
            <a href="#home" className="hover:text-cyber-purple transition-colors">
              Accueil
            </a>
            <a href="#about" className="hover:text-cyber-blue transition-colors">
              À propos
            </a>
            <a href="#skills" className="hover:text-cyber-blue transition-colors">
              Compétences
            </a>
            <a href="#services" className="hover:text-cyber-purple transition-colors">
              Services
            </a>
            <a href="#projects" className="hover:text-cyber-blue transition-colors">
              Projets
            </a>
            <a href="#contact" className="hover:text-cyber-blue transition-colors">
              Contact
            </a>
          </div>
